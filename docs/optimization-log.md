...
## 真实待做清单（2026-07-01 清理过时记录）

### 小的、可以立即扫掉的

| # | 问题 | 工作量 | 状态 |
|---|------|--------|------|
| 1 | 标书导出用文件保存对话框(而非当前目录) | 3行 | 待做 |
| 2 | 日期加「近7天」快捷按钮 | 3行 | 待做 |
| 3 | 爬虫重试机制 | 10行 | 待做 |
...
| # | 问题 | 工作量 | 状态 |
|---|------|--------|------|
| 4 | AI 分析追加不覆盖(当前每次覆盖上一条) | 20行 | 待做 |
| 5 | main.py Web 拆分(200行HTML内嵌) | 30min | 待做 |
| 6 | cebpubservice 翻更多页(3→10页) | 改1个参数 | 待做 |

### 大的/方向性的

| # | 问题 | 说明 |
|---|------|------|
| 7 | ggzy Playwright 关键词搜索 | 关键词真正生效的唯一出路 |
| 8 | knowledge/ 继续扩充 | 持续积累，不改代码 |
